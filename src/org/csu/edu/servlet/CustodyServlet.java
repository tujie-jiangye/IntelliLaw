/*
** CustodyServlet is located in the servlet layer,
* the main function is to receive the client about the custody dispute request parameters,
* and call the lower module service layer handles the business logic,
 ...
 * In addition, CustodyServlet also performs some error handling,
